...
{
    public class HT_ThongTinNguoiHienTinh : BaseThongTinBenhNhan
    {
        public HT_ThongTinNguoiHienTinh(string maBN) : base(maBN)
        {
        }

        public int TrinhDoHocVan { set; get; }
        public string CongViec { set; get; }

        public bool DaLapGiaDinh { set; get; }
        public bool DaCoCon { set; get; }
        public int SoCon { set; get; }
        public int TuoiCoConGanNhat { set; get; }
        public int ThoiDiemVoMangThai { set; get; }

        public string TrangThaiSucKhoe { set; get; }
        public string TieuSuBenh { set; get; }
        public string TieuSuBenhGiaDinh { set; get; }

        

        public DateTime NgayTao { set; get; }

        public HT_ThongTinNguoiHienTinh(XDocument xDoc)
        {
            var xDLBNHT = xDoc.Element("HT_TTBN");
            ...
            this.TrinhDoHocVan = Convert.ToInt32(xTTCB.Element("TrinhDoHocVan").Value);
            this.CongViec = xTTCB.Element("CongViec").Value;
            ...
            var xMarriageInformation = xDLBNHT.Element("ThongTinKetHon");
            this.DaLapGiaDinh = Convert.ToBoolean(xMarriageInformation.Element("DaLapGiaDinh").Value);
            this.DaCoCon = Convert.ToBoolean(xMarriageInformation.Element("DaCoCon").Value);
            this.SoCon = Convert.ToInt32(xMarriageInformation.Element("SoCon").Value);
            this.TuoiCoConGanNhat = Convert.ToInt32(xMarriageInformation.Element("TuoiCoConGanNhat").Value);
            this.ThoiDiemVoMangThai = Convert.ToInt32(xMarriageInformation.Element("ThoiDiemVoMangThai").Value);

            var xHeathStatus = xDLBNHT.Element("ThongTinSucKhoe");
            this.TrangThaiSucKhoe = xHeathStatus.Element("TrangThaiSucKhoe").Value;
            this.TieuSuBenh = xHeathStatus.Element("TieuSuBenh").Value;
            this.TieuSuBenhGiaDinh = xHeathStatus.Element("TieuSuBenhGiaDinh").Value;
